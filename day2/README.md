# Labs: Matrix Multiplication, Pointers, and Streams

Now that you have familiarized yourself with the Vitis HLS tool flow, and you have learnt about Vitis HLS support, data types and bit accuracy, pointer limitations and streams, it's time to deepen our understanding with the following labs. 
