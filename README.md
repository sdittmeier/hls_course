...
Following the style of the lecture, the tutorials and labs are organized in their corresponding directories.
You start at [day1](./day1/README.md), which introduces you to the Vitis HLS tool flow, and follow [day2](./day2/README.md) - [day5](./day5/README.md) through the days of the week. 
